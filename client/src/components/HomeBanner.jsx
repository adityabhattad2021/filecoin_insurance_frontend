    ...
    return(
        ...
        viewport={{ once: false, amount: 0.25 }} className="h-[100vh] bg-[#3BBDB6] w-screen flex flex-col px-12 py-20 sm:flex-row sm:py-4" id="#">
            <motion.div variants={buttonVariant(0.8)} className="flex-1 my-auto">
                <h1 className="text-[20px] py-4 text-white font-bold md:text-[36px]">Safeguard your cryptocurrencies and other digital assets</h1>
                <p className="text-[#d2d2d2] text-[10px] mb-4 font-bold md:text-[16px]">We at cryptosurance provide insurance to storage provider to protect them from crypto crash</p>
